...
public class BookingInfoStage extends Stage {
    ...
    public BookingInfoStage(RoomDao roomDao, BookingDao bookingDao) {

        this.setResizable(false);
        bookingStage = new BookingStage(roomDao, bookingDao);

        _pane1 = new Pane();
        _pane1.setPrefHeight(FxApplication.SCENE_HEIGHT >> 1);
        _pane1.setPrefWidth(FxApplication.SCENE_WIDTH);
        ...
        _pane2 = new Pane();
        _pane2.setLayoutY(FxApplication.SCENE_HEIGHT >> 1);
        _pane2.setPrefHeight(FxApplication.SCENE_HEIGHT >> 1);
        _pane2.setPrefWidth(FxApplication.SCENE_WIDTH);
    ...
    private void createStage() {
        ...
        anchorPane.setPrefHeight(FxApplication.SCENE_HEIGHT);
        anchorPane.setPrefWidth(FxApplication.SCENE_WIDTH);
        showBooking("");
