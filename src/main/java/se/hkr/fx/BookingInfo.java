...
public class BookingInfo extends Stage {
    ...
    public BookingInfo(Booking booking, PersonalAreaCus session, BookingDao bookingDao) {
    ...
    private void createScene(){
        ...
        text.setText("Booking #"+booking.getbId()+"");
...
//        text6.setFont(new Font("AppleGothic Regular", 18));
        ...
        movein.setText(booking.getMovein().format(DateTimeFormatter.ofPattern("dd-MM-yyyy")));
        ...
        moveout.setText(booking.getMoveout().format(DateTimeFormatter.ofPattern("dd-MM-yyyy")));
...
//        text9.setFont(new Font("AppleGothic Regular", 18));
        ...
        guests.setText(""+booking.getGuests()+"");
        ...
        button4.setOnAction(event -> {
            ...
            )
            {
                ...
                this.bookingDao.updateBooking(booking.getbId(), in, out, Integer.parseInt(guests.getText()), room.getText());
                booking.setMovein(in);
                booking.setMoveout(out);
                booking.setGuests(Byte.parseByte(guests.getText()));
        ...
        Scene scene = new Scene(paneMain, FxApplication.SCENE_WIDTH, FxApplication.SCENE_HEIGHT);
    ...
    private void closeStage() {
        this.bookingDao.deleteBooking(this.booking.getbId());
        session.getBooks().remove(booking);
        session.loadButtons();
