...
//        myApp.showMenu();
       ...
       //Logger.logUML(Main.class, true);
//        Logger.logUML(BookingInfo.class, true);
//        Logger.logUML(CreateCustomer.class, true);
//        Logger.logUML(Config.class, true);
//        Logger.logUML(FxmlConverter.class, true);
//        Logger.logUML(HomeStage.class, true);
//        Logger.logUML(Localization.class, true);
//        Logger.logUML(Logger.class, true);
//        Logger.logUML(LoggerQueue.class, true);
//        Logger.logUML(LoginCus.class, true);
//        Logger.logUML(LoginEmp.class, true);
//        Logger.logUML(LogThread.class, true);
//        Logger.logUML(MainFX.class, true);
//        Logger.logUML(PersonalAreaCus.class, true);
//        Logger.logUML(PopUP.class, true);
//        Logger.logUML(Translator.class, true);
//        Logger.logUML(DatabaseManager.class, true);
//        Logger.logUML(DatabaseManager.Booking.class, true);
//        Logger.logUML(DatabaseManager.Profile.class, true);
        //out.println((int)(Math.ceil(11 / 3.0) ));
        //FxmlConverter.documentBuild("/Users/Test/Desktop/FXMLs/BookingInfo.fxml");
